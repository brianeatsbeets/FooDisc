...
// This class/text field is used for course coordinate text fields to prevent user from moving cursor back to beginning of text field, which will prevent "rogue" minus signs
